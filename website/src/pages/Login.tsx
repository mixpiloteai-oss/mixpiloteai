        ...
        {mode === 'reset' ? (
          <>
            ...
            <form className="login-form" onSubmit={handleSubmit}>
              ...
              {submitted && <div className="login-success">Reset link sent! Check your inbox.</div>}
              <button type="submit" className="btn-primary login-btn">Send Reset Link</button>
            </form>
            <button className="login-switch" onClick={() => setMode('signin')}>← Back to sign in</button>
          </>
        ) : (
          <>
            ...
            <form className="login-form" onSubmit={handleSubmit}>
              ...
              {mode === 'signin' && (
                <button type="button" className="login-forgot" onClick={() => setMode('reset')}>Forgot password?</button>
              )}
              {submitted && <div className="login-success">{mode === 'signin' ? 'Signed in!' : 'Account created!'}</div>}
