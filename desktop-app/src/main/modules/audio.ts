...
const module = {
  register(ipcMain: IpcMain): void {
    ...
    ipcMain.handle('audio-cache-is-cached',  (_e, url: string)                 => false)
    ipcMain.handle('audio-cache-get-path',   (_e, url: string)                 => null)
    ipcMain.handle('audio-cache-fetch',      (_e, url: string)                 => null)
    ipcMain.handle('audio-cache-store',      (_e, url: string, filePath: string) => null)
    ipcMain.handle('audio-cache-evict',      (_e, url: string)                 => null)
